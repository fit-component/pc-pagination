    ...
    _createClass(ButtonGroup, [{
        ...
        value: function render() {
            ...
            if (this.props.allPage) {
                child = _react2.default.createElement(_allPage2.default, _extends({ ref: 'child' }, this.props));
            } else {
                child = _react2.default.createElement(_simple2.default, _extends({ ref: 'child' }, this.props));
            }
